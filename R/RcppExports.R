...
condense_count <- function(x, z, weight) {
    .Call('bigvis_condense_count', PACKAGE = 'bigvis', x, z, weight)
}

condense_sum <- function(x, z, weight) {
    .Call('bigvis_condense_sum', PACKAGE = 'bigvis', x, z, weight)
}

condense_mean <- function(x, z, weight) {
    .Call('bigvis_condense_mean', PACKAGE = 'bigvis', x, z, weight)
}

condense_sd <- function(x, z, weight) {
    .Call('bigvis_condense_sd', PACKAGE = 'bigvis', x, z, weight)
}

condense_median <- function(x, z, weight) {
    .Call('bigvis_condense_median', PACKAGE = 'bigvis', x, z, weight)
}
